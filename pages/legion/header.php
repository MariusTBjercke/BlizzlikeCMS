    ...
    <div class="navbar-legion">
        ...
        <div class="navbar-nav">
            ...
            <button type="button" title="Open menu" id="toggleNavigation" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
                <div class="toggledMenu">
                    <ul id="toggledMenuUl">
                        ...
                        <!-- TODO: ADD FORUM LINK WHEN IT'S DONE -->
                        ...
                        <li class="<?php if ($page == 'gamemasters') { echo 'mobilemenu-active'; } ?>"><a href="gamemasters.php"><i class="fa fa-star blinking" aria-hidden="true"></i> Staff</a></li>
                    </ul>
                </div>
            ...
            <div class="navbar-list">
                ...
                <div class="navbar-menuitem <?php if ($page == 'gamemasters') { echo 'menuitem-active'; } ?>"><a href="gamemasters.php"><i class="fa fa-star blinking" aria-hidden="true"></i> Staff</a></div>
            </div>
